function [ graphSet ] = createBuildingBRandomGraphData( v, p, nGraphs, runNo)
    ...
    saveRandomGraphDataResult(graphSet,v,p,'BuildingB','RAW',nGraphs, runNo);
