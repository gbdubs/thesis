function createMinusOneCRandomGraphData( v, p , nGraphs, runNo)
    ...
    function [ howAutomorphic ] = automorphicMetric ( A ) 
        ...
        howAutomorphic = sqrt(howAutomorphic);
    end
    ...
    saveRandomGraphDataResult(graphSet, v, p, 'MinusOneC', 'RAW', nGraphs, runNo);
