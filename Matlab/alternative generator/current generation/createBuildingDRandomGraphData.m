function [ graphSet ] = createBuildingDRandomGraphData( v, p, nGraphs, runNo)
    ...
    saveRandomGraphDataResult(graphSet,v,p,'BuildingD','RAW',nGraphs, runNo);
