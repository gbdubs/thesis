function [ graphSet ] = createBuildingERandomGraphData( v, p, nGraphs, runNo)
    ...
    saveRandomGraphDataResult(graphSet,v,p,'BuildingE','RAW',nGraphs, runNo);
