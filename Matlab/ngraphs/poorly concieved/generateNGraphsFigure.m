...
for n = 6 : 11
    [xs, ys] = getGraphableDistribution3(nGraphs, n);
    plot(xs,ys,'DisplayName',['N = ',num2str(n)],'MarkerSize',25,'Marker','.','LineWidth',2);
end

% Create xlabel
xlabel('Connectivity = NEdges / E_{Max}');

% Create ylabel
ylabel(' Proportion of Log ( NGraphs) in Set');
...
%set(legend1, 'Position',[0.470149253731343 0.243392070484583 0.117164179104478 0.280837004405287]);
set(legend1,'Position',[0.177985074626866 0.609340659340659 0.127611940298508 0.28021978021978]);

hold off;

print('ngraphs/proplogwxcvas','-dpng');